...
fn r2r_cargo_to_string(_: &str) -> Result<String, String> {
...
pub fn generate_r2r_cargo(package_name: &str, directory: &str) -> Result<(), String> {
    let file = format!("{}/r2r_cargo.cmake", directory);
    let content = r2r_cargo_to_string(package_name)?;
